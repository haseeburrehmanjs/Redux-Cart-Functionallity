        ...
        <>
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-md" bis_skin_checked={1}>
                ...
                <div className="mt-4" bis_skin_checked={1}>
                    ...
                    <p className="mt-1">$ {Math.round(price)}</p>
                    <div className='text-center mt-3'>
                        <button onClick={()=> addToCart(item)} type="button" className="text-white bg-pink-700 hover:bg-pink-600 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2">
